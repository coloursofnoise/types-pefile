...
from typing import Any, Callable, Literal, ParamSpec, Self, TypeVar, Union, overload
...
def b(x: bytes | bytearray | str | ReadableBuffer) -> bytes: ...
...
class Structure:
    ...
    def sizeof(self) -> int:
        ...
        ...
    def __unpack__(self, data: Any) -> None: ...
    ...
    def dump(self, indentation: int = ...) -> list[str]:
        ...
        ...
    def dump_dict(self) -> dict[str, str | dict[str, Any]]:
...
class SectionStructure(Structure):
    ...
    def get_hash_md5(self) -> str | None:
        ...
        ...
    def entropy_H(self, data: bytearray) -> float | Literal[0]:
...
class StructureWithBitfields(Structure):
    ...
    def __unpack__(self, data: bytes) -> None: ...
    def __pack__(self) -> bytes: ...
    def dump(self, indentation: int = ...) -> list[str]: ...
...
class UnwindInfo(StructureWithBitfields):
    ...
    * optional ExceptionHandler and FunctionEntry fields
    ...
    def unpack_in_stages(self, data: Any) -> str | None:
    ...
    """
    def __pack__(self) -> bytes: ...
    def get_chained_function_entry(self) -> Any: ...
    def set_chained_function_entry(self, entry: Any) -> None: ...
...
def is_valid_dos_filename(s: str) -> bool: ...

allowed_function_name: bytes = ...

@lru_cache(maxsize=2048)
def is_valid_function_name(
    s: Union[str, bytes, bytearray], relax_allowed_characters: bool = ...
) -> bool: ...
...
class PE(AbstractContextManager["PE"]):
    ...
    def __exit__(
        self, type: type[BaseException] | None, value: Any, traceback: Any
    ) -> None: ...
    def close(self) -> None: ...
    def __unpack_data__(
        self, format: _STRUCTURE_FORMAT, data: bytes | bytearray, file_offset: int
    ) -> Structure | None:
    ...
    def __unpack_data_with_bitfields__(
        self, format: _STRUCTURE_FORMAT, data: bytes, file_offset: int
    ...
    @overload
    def __parse__(
        self, fname: None, data: mmap.mmap | bytearray, fast_load: bool
    ) -> None:
    ...
    def write(self, filename: str | None = ...) -> bytearray | None:
        """Write the PE file.
    ...
    def parse_resource_entry(self, rva: int) -> Structure | None:
        ...
        ...
    def parse_version_information(self, version_struct: Any) -> None:
    ...
    def get_resources_strings(self) -> list[str]:
        ...
        """
        ...
    def get_data(self, rva: int = ..., length: int | None = ...) -> bytes | bytearray:
    ...
    def get_string_at_rva(self, rva: int, max_length: int | None = ...) -> bytes:
        ...
        ...
    def get_bytes_from_data(self, offset: int, data: bytes) -> bytes:
        """."""
        ...
    def get_string_from_data(self, offset: int, data: bytes) -> bytes:
    ...
    def get_physical_by_rva(self, rva: int) -> int:
        ...
        ...
    def get_data_from_dword(self, dword: int) -> bytes:
        """Return a four byte string representing the double word value (little endian)."""
        ...
    def get_dword_from_data(self, data: bytes, offset: int) -> Any | None:
        ...
        """
        ...
    def get_dword_at_rva(self, rva: int) -> Any | None:
        ...
        """
        ...
    def get_dword_from_offset(self, offset: int) -> Any | None:
        """Return the double word value at the given file offset. (little endian)"""
        ...
    def set_dword_at_rva(self, rva: int, dword: int) -> bool:
        """Set the double word value at the file offset corresponding to the given RVA."""
        ...
    def set_dword_at_offset(self, offset: int, dword: int) -> bool:
        """Set the double word value at the given file offset."""
        ...
    def get_data_from_word(self, word: int) -> bytes:
        """Return a two byte string representing the word value. (little endian)."""
        ...
    def get_word_from_data(self, data: bytes, offset: int) -> Any | None:
        ...
        """
        ...
    def get_word_at_rva(self, rva: int) -> Any | None:
        ...
        """
        ...
    def get_word_from_offset(self, offset: int) -> Any | None:
        """Return the word value at the given file offset. (little endian)"""
        ...
    def set_word_at_rva(self, rva: int, word: int) -> bool:
        """Set the word value at the file offset corresponding to the given RVA."""
        ...
    def set_word_at_offset(self, offset: int, word: int) -> bool:
        """Set the word value at the given file offset."""
        ...
    def get_data_from_qword(self, word: int) -> bytes:
        """Return an eight byte string representing the quad-word value (little endian)."""
        ...
    def get_qword_from_data(self, data: bytes, offset: int) -> Any | None:
        ...
        """
        ...
    def get_qword_at_rva(self, rva: int) -> Any | None:
        ...
        """
        ...
    def get_qword_from_offset(self, offset: int) -> Any | None:
        """Return the quad-word value at the given file offset. (little endian)"""
        ...
    def set_qword_at_rva(self, rva: int, qword: int) -> bool:
        """Set the quad-word value at the file offset corresponding to the given RVA."""
        ...
    def set_qword_at_offset(self, offset: int, qword: int) -> bool:
        """Set the quad-word value at the given file offset."""
        ...
    def set_bytes_at_rva(self, rva: int, data: bytes) -> bool:
        ...
        """
        ...
    def set_bytes_at_offset(self, offset: int, data: bytes) -> bool:
        ...
        """
        ...
    def set_data_bytes(self, offset: int, data: bytes) -> None: ...
