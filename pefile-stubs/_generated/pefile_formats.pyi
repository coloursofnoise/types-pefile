...
IMAGE_INDIR_CONTROL_TRANSFER_DYNAMIC_RELOCATION_format = tuple[IMAGE_INDIR_CONTROL_TRANSFER_DYNAMIC_RELOCATION_format_name,tuple[Literal["H:12,PageRelativeOffset"],Literal["H:1,IndirectCall"],Literal["H:1,RexWPrefix"],Literal["H:1,CfgCheck"],Literal["H:1,Reserved"]]]
IMAGE_SWITCHTABLE_BRANCH_DYNAMIC_RELOCATION_format_name = Literal["IMAGE_SWITCHTABLE_BRANCH_DYNAMIC_RELOCATION"]
IMAGE_SWITCHTABLE_BRANCH_DYNAMIC_RELOCATION_format = tuple[IMAGE_SWITCHTABLE_BRANCH_DYNAMIC_RELOCATION_format_name,tuple[Literal["H:12,PageRelativeOffset"],Literal["H:4,RegisterNumber"]]]
IMAGE_FUNCTION_OVERRIDE_HEADER_format_name = Literal["IMAGE_FUNCTION_OVERRIDE_HEADER"]
IMAGE_FUNCTION_OVERRIDE_HEADER_format = tuple[IMAGE_FUNCTION_OVERRIDE_HEADER_format_name,tuple[Literal["I,FuncOverrideSize"]]]
IMAGE_FUNCTION_OVERRIDE_DYNAMIC_RELOCATION_format_name = Literal["IMAGE_FUNCTION_OVERRIDE_DYNAMIC_RELOCATION"]
IMAGE_FUNCTION_OVERRIDE_DYNAMIC_RELOCATION_format = tuple[IMAGE_FUNCTION_OVERRIDE_DYNAMIC_RELOCATION_format_name,tuple[Literal["I,OriginalRva"],Literal["I,BDDOffset"],Literal["I,RvaSize"],Literal["I,BaseRelocSize"]]]
IMAGE_BDD_INFO_format_name = Literal["IMAGE_BDD_INFO"]
IMAGE_BDD_INFO_format = tuple[IMAGE_BDD_INFO_format_name,tuple[Literal["I,Version"],Literal["I,BDDSize"]]]
IMAGE_BDD_DYNAMIC_RELOCATION_format_name = Literal["IMAGE_BDD_DYNAMIC_RELOCATION"]
IMAGE_BDD_DYNAMIC_RELOCATION_format = tuple[IMAGE_BDD_DYNAMIC_RELOCATION_format_name,tuple[Literal["H,Left"],Literal["H,Right"],Literal["I,Value"]]]
...
class PE:
    ...
    __IMAGE_FUNCTION_OVERRIDE_HEADER_format__: IMAGE_FUNCTION_OVERRIDE_HEADER_format = ...
    __IMAGE_FUNCTION_OVERRIDE_DYNAMIC_RELOCATION_format__: IMAGE_FUNCTION_OVERRIDE_DYNAMIC_RELOCATION_format = ...
    __IMAGE_BDD_INFO_format__: IMAGE_BDD_INFO_format = ...
    __IMAGE_BDD_DYNAMIC_RELOCATION_format__: IMAGE_BDD_DYNAMIC_RELOCATION_format = ...
